...
<div class="flexible-block || container__small || padding__top-small padding__bottom-small" data-template="small-info-block">
    <div class="flexible-block__inner">

        <div class="fb-home-small-info-block || text-content">
            <?php if(!isset($smallInfoHeadline)): ?>
                <h2 class="heading heading__h2"><?php echo $smallInfoHeadline; ?></h2>
            <?php endif; ?>
